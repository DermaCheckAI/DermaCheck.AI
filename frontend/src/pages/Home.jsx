  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black relative overflow-hidden">
      ...
      <main className="relative z-5 flex-1 flex items-center justify-center">
        <div className="w-full max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between py-20 gap-20 px-8">
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-5xl md:text-7xl font-extrabold bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent mb-8">
          ...
          {/* Login Form */}
          <div className="flex-1 max-w-md w-full bg-white bg-opacity-5 backdrop-blur-lg border border-cyan-400 rounded-2xl p-10">
            ...
            <form onSubmit={submit} className="flex flex-col gap-6">
              <input
                ...
                value={form.email}
                onChange={handle}
                className="w-full px-5 py-3 rounded-lg bg-black bg-opacity-30 text-white border border-cyan-400"
                required
              />
            ...
            {msg && (
              <p className={`text-center mt-4 ${msg.includes('successful') ? 'text-green-400' : 'text-red-400'}`}>
                {msg}
              </p>
            )}
      ...
      {showScrollButton && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 bg-cyan-500 text-white rounded-full p-3 shadow-lg"
        >
          ↑
        </button>
      )}
